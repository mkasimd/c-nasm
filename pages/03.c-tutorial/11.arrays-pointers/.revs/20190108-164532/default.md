...
When passing pointers however, make sure to either have the last element set `NULL` or deliver the length either, such that you don't access an element outside of the assigned memory and avoid a `Segmentation Fault` or an unexpected behavior.
