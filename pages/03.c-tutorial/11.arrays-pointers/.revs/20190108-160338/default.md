...
int main(){
    ...
    printf("Arr @ %p\tArr val %p\n", &arr, arr);
    printf("Ptr @ %p\tPtr val %p\n", &ptr, ptr);
...
```sh
$ gcc -o arrptr arrptr.c && ./arrptr
Arr @ 0x7fffda7b4d90	Arr val 0x7fffda7b4d90
Ptr @ 0x7fffda7b4d88	Ptr val 0x7fffda7b4d90
```
...
This Assembly also shows clearly that the array and the pointer are very much different.
