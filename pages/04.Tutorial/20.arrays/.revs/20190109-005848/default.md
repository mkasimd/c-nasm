...
!!! NOTE: Look at the [Arrays and Pointers in C](../../c-tutorial/arrays-pointers) section to understand the difference between them. Also have a look at the [Low Level Look](../../c-tutorial/arrays-pointers#lolelook) of Arrays and Pointers there.
